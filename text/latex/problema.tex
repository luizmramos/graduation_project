...
A classificação de textos é um exemplo clássico de classificação \emph{multi-class / multi-label}, uma vez que o texto pode pertencer a uma ou varias classes simultaneamente.
